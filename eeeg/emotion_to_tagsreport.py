...
def create_tags_reports(predictions, prediction_probas=None, 
...
def export_detailed_report(tags_reports, predictions, true_labels=None, 
                          output_file='detailed_predictions.csv'):
    """
...
def main():
    ...
    # 6. 导出详细报告（可选）
    print("\n" + "="*50)
    detailed_df = export_detailed_report(tags_reports, predictions, true_labels, 
